...
function airstrip(){
  var plane = assembly();
  plane = R([0,2])(-PI/2)(plane);
  plane = R([1,2])(-PI/16)(plane);
  plane = T([0,1,2])([10,-140,10])(plane);

  var sea = COLOR([0/255,206/255,209/255])(
    T([0,1])([-300,-300])(
      CUBOID([600,600,0.3])
    )
  );
  var sand = COLOR([255/255,255/255,224/255])(
    T([0,1,2])([-80,-200,0.3])(
      CUBOID([160,400,0.3])
    )
  );
  var street = COLOR([190/255,190/255,190/255])(
    T([0,1,2])([-20,-175,0.6])(
      CUBOID([40,350,0.3])
    )
  );
