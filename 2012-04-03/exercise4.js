...
//copri-piscina grande
pavimenti.push(
  T([0,1])([1,1])(
    SIMPLEX_GRID([[20], [9], [0.1]])
  )
);
//copri-piscina piccola
pavimenti.push(
  T([0,1])([47,5])(
    SIMPLEX_GRID([[4], [11], [0.1]])
  )
);
...
var panca = (T([0,1,2])([7.9,14.2,(spessorePav+latoCubetto)])(
              SIMPLEX_GRID([[15.2], [0.6], [0.1]])
            ));
COLOR([245/255,245/255,220/255])(panca);
DRAW(STRUCT([panca]));
...
COLOR([245/255,245/255,220/255])(pavimento);
DRAW(pavimento);

var scalini = STRUCT(scale);
COLOR([245/255,245/255,220/255])(scalini);
DRAW(scalini);

var pareti = STRUCT(muri);
COLOR([245/255,245/255,220/255])(pareti);
DRAW(pareti);

var pools = STRUCT(piscine);
COLOR([64/255,224/255,208/255])(pools);
DRAW(pools);

var colonnato = STRUCT(colonne);
COLOR([144/255,135/255,109/255])(colonnato);
DRAW(colonnato);

var aria = STRUCT(vetrate);
COLOR([176/255,224/255,230/255])(aria);
DRAW(aria);

var cubi = STRUCT(cubetti);
COLOR([245/255,245/255,220/255])(cubi);
DRAW(cubi);

var coperture = STRUCT(tetti);
COLOR([47/255,79/255,79/255])(cubi);
DRAW(coperture);
...
var piedi = STRUCT(gambe);
COLOR([184/255,134/255,11/255])(piedi);
DRAW(piedi);

var tavola = (T([0,1,2])([23.8,0.8,(spessorePav+0.8)])(
              SIMPLEX_GRID([[3.4], [2.4], [0.2]])
            ));
COLOR([184/255,134/255,11/255])(tavola);
DRAW(STRUCT([tavola]));
